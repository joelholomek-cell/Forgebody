...
const EXERCISES={
  chest:[
    {name:"Barbell Bench Press",sets:"4",reps:"6-10",rest:"2 min",muscle:"chest",cue:"Retract scapula, bar to lower chest, drive up explosively."},
    {name:"Incline Barbell Press",sets:"4",reps:"8-12",rest:"90 sec",muscle:"chest",cue:"30-45 degree angle, elbows at 75 degrees, press to upper chest."},
    {name:"Incline Dumbbell Press",sets:"3",reps:"10-12",rest:"90 sec",muscle:"chest",cue:"Neutral grip at top, lower to upper pec, full stretch at bottom."},
    {name:"Flat Dumbbell Press",sets:"4",reps:"8-12",rest:"90 sec",muscle:"chest",cue:"Slight arc path, squeeze chest hard at top, controlled descent."},
    {name:"Cable Chest Fly",sets:"3",reps:"12-15",rest:"60 sec",muscle:"chest",cue:"Slight elbow bend, bring hands together in an arc, squeeze pecs."},
    {name:"Dumbbell Fly",sets:"3",reps:"12-15",rest:"60 sec",muscle:"chest",cue:"Wide arc motion, feel deep stretch, squeeze at top."},
    {name:"Dips (chest lean)",sets:"3",reps:"10-15",rest:"90 sec",muscle:"chest",cue:"Lean forward, wide grip, go deep for full pec stretch."},
    {name:"Push-Up",sets:"3",reps:"15-20",rest:"60 sec",muscle:"chest",cue:"Hands shoulder-width, lower chest to floor, full lockout at top."},
    {name:"Decline Bench Press",sets:"3",reps:"8-12",rest:"90 sec",muscle:"chest",cue:"Decline hits lower chest, bar to lower sternum."},
    {name:"Pec Deck Machine",sets:"3",reps:"12-15",rest:"60 sec",muscle:"chest",cue:"Elbows at 90 degrees, squeeze pecs hard at contraction point."},
    {name:"Low Cable Fly",sets:"3",reps:"12-15",rest:"60 sec",muscle:"chest",cue:"Cables at floor level, arc upward, crosses hit upper chest."},
    {name:"Close-Grip Push-Up",sets:"3",reps:"12-20",rest:"60 sec",muscle:"chest",cue:"Hands close together, elbows track back."},
    {name:"Chest Press Machine",sets:"3",reps:"10-15",rest:"60 sec",muscle:"chest",cue:"Adjust seat so handles align with mid-chest, full ROM."},
    {name:"Landmine Press",sets:"3",reps:"10-12",rest:"75 sec",muscle:"chest",cue:"Single arm, arc the bar up and out, great for upper chest."},
    {name:"Push-Up Wide",sets:"3",reps:"12-20",rest:"60 sec",muscle:"chest",cue:"Wide hand placement targets outer chest more."},
    {name:"Around The Worlds",sets:"3",reps:"12-15",rest:"60 sec",muscle:"chest",cue:"Light weight, full arc motion for chest stretch and activation."},
    {name:"Alternating Floor Press",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"chest",cue:"Floor limits ROM, great for lockout strength."},
    {name:"Cable Incline Fly",sets:"3",reps:"12-15",rest:"60 sec",muscle:"chest",cue:"Cables low, arc up and in, hits upper chest."},
  ],
  back:[
    {name:"Deadlift",sets:"4",reps:"4-6",rest:"3 min",muscle:"back",cue:"Bar over mid-foot, neutral spine. Drive floor away, hips lock out at top."},
    {name:"Barbell Row",sets:"4",reps:"6-10",rest:"2 min",muscle:"back",cue:"Hinge to 45 degrees, pull bar to belly button, squeeze lats."},
    {name:"Pull-Up",sets:"4",reps:"6-10",rest:"2 min",muscle:"back",cue:"Dead hang start, drive elbows down, chin over bar."},
    {name:"Lat Pulldown",sets:"4",reps:"10-12",rest:"90 sec",muscle:"back",cue:"Lean back slightly, pull bar to upper chest, feel lats stretch at top."},
    {name:"Seated Cable Row",sets:"4",reps:"10-12",rest:"90 sec",muscle:"back",cue:"Sit tall, pull to belly button, squeeze shoulder blades together."},
    {name:"Face Pull",sets:"3",reps:"15-20",rest:"60 sec",muscle:"back",cue:"Pull to forehead, external rotate at end, rear delt and rotator cuff."},
    {name:"Single-Arm Dumbbell Row",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"back",cue:"Brace on bench, pull elbow to hip, full stretch at bottom."},
    {name:"T-Bar Row",sets:"4",reps:"8-12",rest:"90 sec",muscle:"back",cue:"Chest on pad, pull handles to chest, squeeze hard at top."},
    {name:"Wide-Grip Pull-Up",sets:"3",reps:"6-10",rest:"2 min",muscle:"back",cue:"Wide grip hits lats more, full dead hang between reps."},
    {name:"Close-Grip Lat Pulldown",sets:"3",reps:"10-12",rest:"90 sec",muscle:"back",cue:"V-bar attachment, pull to chest, great lat stretch."},
    {name:"Chest-Supported Row",sets:"3",reps:"10-12",rest:"90 sec",muscle:"back",cue:"Removes lower back from equation, pure upper back focus."},
    {name:"Meadows Row",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"back",cue:"Landmine setup, elbow drives back and up, great stretch."},
    {name:"Rack Pull",sets:"4",reps:"4-6",rest:"3 min",muscle:"back",cue:"Bar starts at knee height, lockout focus, massive trap builder."},
    {name:"Straight-Arm Pulldown",sets:"3",reps:"12-15",rest:"60 sec",muscle:"back",cue:"Arms straight, hinge at shoulder, feel lats fully stretch."},
    {name:"Pendlay Row",sets:"4",reps:"5-6",rest:"2 min",muscle:"back",cue:"Bar returns to floor each rep. Explosive pull. Pure power."},
    {name:"Alternating Kettlebell Row",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"back",cue:"Alternate arms, keep hips square."},
    {name:"Inverted Row",sets:"3",reps:"10-15",rest:"75 sec",muscle:"back",cue:"Body straight, pull chest to bar, squeeze scapula."},
    {name:"Axle Deadlift",sets:"4",reps:"4-6",rest:"3 min",muscle:"back",cue:"Thicker bar challenges grip, same technique as regular deadlift."},
  ],
  shoulders:[
    {name:"Overhead Press",sets:"4",reps:"6-10",rest:"2 min",muscle:"shoulders",cue:"Bar from front rack, press straight up, lock out overhead."},
    {name:"Dumbbell Shoulder Press",sets:"4",reps:"8-12",rest:"90 sec",muscle:"shoulders",cue:"90 degree elbow start, press to lockout, slight arc inward."},
    {name:"Dumbbell Lateral Raise",sets:"3",reps:"12-15",rest:"60 sec",muscle:"shoulders",cue:"Slight forward tilt, lead with elbows, stop at shoulder height."},
    {name:"Cable Lateral Raise",sets:"3",reps:"12-15",rest:"60 sec",muscle:"shoulders",cue:"Constant tension through full ROM, squeeze at top."},
    {name:"Arnold Press",sets:"3",reps:"10-12",rest:"90 sec",muscle:"shoulders",cue:"Rotate from palms facing you to palms forward as you press."},
    {name:"Rear Delt Fly",sets:"3",reps:"12-15",rest:"60 sec",muscle:"shoulders",cue:"Hinge forward, lead with elbows, squeeze rear delts at top."},
    {name:"Upright Row",sets:"3",reps:"10-12",rest:"75 sec",muscle:"shoulders",cue:"Pull to chin, elbows lead and go above wrists."},
    {name:"Front Raise",sets:"3",reps:"12-15",rest:"60 sec",muscle:"shoulders",cue:"Controlled raise to eye level, lower slowly."},
    {name:"Machine Shoulder Press",sets:"3",reps:"10-15",rest:"75 sec",muscle:"shoulders",cue:"Adjust seat, full ROM, great for volume work."},
    {name:"Cable Y-Raise",sets:"3",reps:"15-20",rest:"60 sec",muscle:"shoulders",cue:"Arms form Y shape, great for rear delt and rotator cuff health."},
    {name:"Barbell Shrug",sets:"4",reps:"10-15",rest:"75 sec",muscle:"shoulders",cue:"Straight up shrug, hold at top, no rolling."},
    {name:"Dumbbell Shrug",sets:"3",reps:"12-15",rest:"60 sec",muscle:"shoulders",cue:"Full range, pause at top, feel trap contraction."},
    {name:"Reverse Pec Deck",sets:"3",reps:"12-15",rest:"60 sec",muscle:"shoulders",cue:"Face the machine, pull handles back, rear delt focus."},
    {name:"Alternating Deltoid Raise",sets:"3",reps:"12 each",rest:"60 sec",muscle:"shoulders",cue:"Alternate front and lateral raises for full delt development."},
    {name:"Alternating Cable Shoulder Press",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"shoulders",cue:"Alternate arms, constant cable tension."},
  ],
  biceps:[
    {name:"Barbell Curl",sets:"4",reps:"8-12",rest:"90 sec",muscle:"biceps",cue:"Elbows pinned, full extension at bottom, squeeze at top."},
    {name:"Hammer Curl",sets:"3",reps:"10-12",rest:"75 sec",muscle:"biceps",cue:"Neutral grip targets brachialis, controlled tempo."},
    {name:"Incline Dumbbell Curl",sets:"3",reps:"10-12",rest:"75 sec",muscle:"biceps",cue:"Incline stretches long head, great peak contraction."},
    {name:"Cable Curl",sets:"3",reps:"12-15",rest:"60 sec",muscle:"biceps",cue:"Constant tension, squeeze hard at top, slow negative."},
    {name:"Concentration Curl",sets:"3",reps:"12-15",rest:"60 sec",muscle:"biceps",cue:"Elbow on inner thigh, full ROM, mind-muscle connection."},
    {name:"Preacher Curl",sets:"3",reps:"10-12",rest:"75 sec",muscle:"biceps",cue:"Full stretch at bottom, don't let elbows lift off pad."},
    {name:"Zottman Curl",sets:"3",reps:"10-12",rest:"75 sec",muscle:"biceps",cue:"Curl up supinated, rotate to pronated on the way down."},
    {name:"Spider Curl",sets:"3",reps:"10-12",rest:"75 sec",muscle:"biceps",cue:"Chest on incline bench, hang arms straight down, curl up."},
    {name:"Cable Hammer Curl",sets:"3",reps:"12-15",rest:"60 sec",muscle:"biceps",cue:"Rope attachment, neutral grip, split at top."},
    {name:"EZ-Bar Curl",sets:"4",reps:"8-12",rest:"90 sec",muscle:"biceps",cue:"Angled grip reduces wrist strain, full ROM."},
    {name:"Cross-Body Hammer Curl",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"biceps",cue:"Curl across body, hits brachialis and brachioradialis."},
    {name:"21s",sets:"3",reps:"21",rest:"90 sec",muscle:"biceps",cue:"7 bottom half, 7 top half, 7 full reps. Brutal pump."},
    {name:"Alternate Hammer Curl",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"biceps",cue:"Alternate arms, neutral grip, controlled tempo."},
    {name:"Alternate Incline Dumbbell Curl",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"biceps",cue:"Incline bench, alternate arms for full stretch."},
  ],
  triceps:[
    {name:"Close-Grip Bench Press",sets:"4",reps:"6-10",rest:"2 min",muscle:"triceps",cue:"Hands shoulder-width, elbows stay close to body, lock out hard."},
    {name:"Tricep Pushdown",sets:"4",reps:"10-15",rest:"75 sec",muscle:"triceps",cue:"Elbows locked at sides, push to full extension, squeeze."},
    {name:"Overhead Tricep Extension",sets:"3",reps:"10-12",rest:"75 sec",muscle:"triceps",cue:"Arms by ears, full stretch overhead, extend to lockout."},
    {name:"Skull Crusher",sets:"3",reps:"10-12",rest:"90 sec",muscle:"triceps",cue:"Bar to forehead, elbows point up, full extension."},
    {name:"Rope Pushdown",sets:"3",reps:"12-15",rest:"60 sec",muscle:"triceps",cue:"Split rope at bottom, pronate hands, squeeze triceps."},
    {name:"Dips (tricep focus)",sets:"3",reps:"10-15",rest:"90 sec",muscle:"triceps",cue:"Upright torso, elbows back, full lockout at top."},
    {name:"Diamond Push-Up",sets:"3",reps:"12-20",rest:"60 sec",muscle:"triceps",cue:"Hands form diamond, elbows track back, maximum tricep."},
    {name:"Single-Arm Pushdown",sets:"3",reps:"12-15 each",rest:"60 sec",muscle:"triceps",cue:"Single arm, full extension, squeeze at bottom."},
    {name:"Tate Press",sets:"3",reps:"12-15",rest:"75 sec",muscle:"triceps",cue:"Elbows point out, lower to chest, press by extending."},
    {name:"JM Press",sets:"3",reps:"8-10",rest:"90 sec",muscle:"triceps",cue:"Bar comes to throat, hybrid of skull crusher and press."},
    {name:"Cable Overhead Extension",sets:"3",reps:"12-15",rest:"60 sec",muscle:"triceps",cue:"Cable behind head, full stretch, extend to lockout."},
    {name:"Kickback",sets:"3",reps:"12-15 each",rest:"60 sec",muscle:"triceps",cue:"Upper arm parallel to floor, extend fully, squeeze at lockout."},
    {name:"Cable Incline Triceps Extension",sets:"3",reps:"12-15",rest:"60 sec",muscle:"triceps",cue:"Incline bench, cable overhead, full stretch."},
    {name:"Cable Lying Triceps Extension",sets:"3",reps:"12-15",rest:"60 sec",muscle:"triceps",cue:"Lying on bench, cable at head, extend fully."},
  ],
  quads:[
    {name:"Barbell Back Squat",sets:"4",reps:"6-10",rest:"3 min",muscle:"quads",cue:"Bar on traps, chest up, knees out, drive through heels."},
    {name:"Front Squat",sets:"4",reps:"6-10",rest:"3 min",muscle:"quads",cue:"Clean grip or cross-arm, elbows high, upright torso."},
    {name:"Leg Press",sets:"4",reps:"10-15",rest:"90 sec",muscle:"quads",cue:"Feet shoulder-width, lower until 90 degrees, don't lock out."},
    {name:"Leg Extension",sets:"3",reps:"12-15",rest:"75 sec",muscle:"quads",cue:"Extend fully, squeeze quads at top, slow negative."},
    {name:"Bulgarian Split Squat",sets:"3",reps:"10-12 each",rest:"90 sec",muscle:"quads",cue:"Rear foot elevated, front foot far enough to keep torso upright."},
    {name:"Walking Lunges",sets:"3",reps:"12-16 steps",rest:"90 sec",muscle:"quads",cue:"Long stride, back knee nearly touches floor, push off front foot."},
    {name:"Goblet Squat",sets:"3",reps:"12-15",rest:"75 sec",muscle:"quads",cue:"Hold dumbbell at chest, elbows inside knees at bottom."},
    {name:"Hack Squat",sets:"4",reps:"10-12",rest:"90 sec",muscle:"quads",cue:"Machine hack squat, feet high = more glutes, feet low = more quads."},
    {name:"Sissy Squat",sets:"3",reps:"10-15",rest:"75 sec",muscle:"quads",cue:"Lean back, knees drive forward, extreme quad isolation."},
    {name:"Step-Up",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"quads",cue:"Drive through heel of elevated foot, squeeze glute at top."},
    {name:"Box Squat",sets:"4",reps:"6-8",rest:"2 min",muscle:"quads",cue:"Sit back to box, pause, drive up explosively."},
    {name:"Narrow Stance Leg Press",sets:"3",reps:"12-15",rest:"75 sec",muscle:"quads",cue:"Feet close together targets outer quad sweep."},
    {name:"Cyclist Squat",sets:"3",reps:"12-15",rest:"75 sec",muscle:"quads",cue:"Heels elevated, upright torso, devastating quad burn."},
    {name:"Barbell Jump Squat",sets:"3",reps:"6-8",rest:"2 min",muscle:"quads",cue:"Light weight, explode up, land softly and reset."},
    {name:"Dumbbell Lunge",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"quads",cue:"Step forward, back knee to floor, drive back up."},
  ],
  hamstrings:[
    {name:"Romanian Deadlift",sets:"4",reps:"8-12",rest:"2 min",muscle:"hamstrings",cue:"Push hips back, soft knee bend, bar stays close to legs."},
    {name:"Lying Leg Curl",sets:"4",reps:"10-12",rest:"90 sec",muscle:"hamstrings",cue:"Curl heels to glutes, squeeze hard at top, slow negative."},
    {name:"Seated Leg Curl",sets:"3",reps:"10-12",rest:"75 sec",muscle:"hamstrings",cue:"Seated version provides different stretch, great for isolation."},
    {name:"Good Morning",sets:"3",reps:"10-12",rest:"90 sec",muscle:"hamstrings",cue:"Bar on traps, hinge at hips, feel hamstring stretch."},
    {name:"Nordic Curl",sets:"3",reps:"5-8",rest:"2 min",muscle:"hamstrings",cue:"Feet anchored, lower body slowly using hamstrings, brutal."},
    {name:"Stiff-Leg Deadlift",sets:"3",reps:"10-12",rest:"90 sec",muscle:"hamstrings",cue:"Legs straighter than RDL, more lower back involved."},
    {name:"Glute-Ham Raise",sets:"3",reps:"8-10",rest:"90 sec",muscle:"hamstrings",cue:"GHD machine, lower body using hamstrings, pull up with them."},
    {name:"Cable Pull-Through",sets:"3",reps:"12-15",rest:"75 sec",muscle:"hamstrings",cue:"Hip hinge movement, cable between legs, drive hips forward."},
    {name:"Single-Leg RDL",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"hamstrings",cue:"Balance on one leg, hinge forward, dumbbell tracks down leg."},
    {name:"Swiss Ball Leg Curl",sets:"3",reps:"10-15",rest:"75 sec",muscle:"hamstrings",cue:"Hips raised, roll ball toward glutes with heels."},
    {name:"Sumo Romanian Deadlift",sets:"3",reps:"10-12",rest:"90 sec",muscle:"hamstrings",cue:"Wide stance, toes out, feels inner hamstring and adductors."},
    {name:"Sumo Deadlift",sets:"4",reps:"5-6",rest:"3 min",muscle:"hamstrings",cue:"Wide stance, toes out, hips drop lower, pulls hamstrings hard."},
  ],
  glutes:[
    {name:"Hip Thrust",sets:"4",reps:"10-15",rest:"90 sec",muscle:"glutes",cue:"Bar over hips, drive through heels, squeeze glutes at top."},
    {name:"Barbell Glute Bridge",sets:"4",reps:"12-15",rest:"75 sec",muscle:"glutes",cue:"Floor version of hip thrust, great for beginners."},
    {name:"Glute Kickback",sets:"3",reps:"12-15 each",rest:"60 sec",muscle:"glutes",cue:"All fours, drive heel to ceiling, squeeze glute at top."},
    {name:"Walking Lunge",sets:"3",reps:"12-16 steps",rest:"90 sec",muscle:"glutes",cue:"Long stride for more glute, push off front heel."},
    {name:"Abduction Machine",sets:"3",reps:"15-20",rest:"60 sec",muscle:"glutes",cue:"Drive knees apart, squeeze glute med at top."},
    {name:"Cable Kickback",sets:"3",reps:"12-15 each",rest:"60 sec",muscle:"glutes",cue:"Ankle attachment, kick back and up, squeeze glute."},
    {name:"Reverse Hyper",sets:"3",reps:"12-15",rest:"75 sec",muscle:"glutes",cue:"Hips off pad, swing legs up, decompresses spine too."},
    {name:"Curtsy Lunge",sets:"3",reps:"12-15 each",rest:"75 sec",muscle:"glutes",cue:"Step behind and across, targets glute med and min."},
    {name:"Frog Pump",sets:"3",reps:"15-20",rest:"60 sec",muscle:"glutes",cue:"Feet together, knees out, glute max isolation."},
    {name:"Single-Leg Hip Thrust",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"glutes",cue:"One leg elevated, double the glute activation."},
    {name:"Sumo Deadlift",sets:"4",reps:"6-8",rest:"3 min",muscle:"glutes",cue:"Wide stance, toes out, hips drop lower, glute dominant."},
    {name:"Donkey Calf Raise",sets:"3",reps:"15-20",rest:"60 sec",muscle:"glutes",cue:"Hinge forward with partner on back, great calf isolation."},
    {name:"Good Morning",sets:"3",reps:"10-12",rest:"90 sec",muscle:"glutes",cue:"Hip hinge, bar on traps, works glutes and hamstrings."},
  ],
  calves:[
    {name:"Standing Calf Raise",sets:"4",reps:"15-20",rest:"60 sec",muscle:"calves",cue:"Full stretch at bottom, pause, rise all the way up."},
    {name:"Seated Calf Raise",sets:"4",reps:"15-20",rest:"60 sec",muscle:"calves",cue:"Bent knee hits soleus more, go heavy, full ROM."},
    {name:"Single-Leg Calf Raise",sets:"3",reps:"12-15 each",rest:"60 sec",muscle:"calves",cue:"Full bodyweight on one leg, maximum stretch."},
    {name:"Leg Press Calf Raise",sets:"4",reps:"15-20",rest:"60 sec",muscle:"calves",cue:"Toes on plate edge, full ROM, go heavy."},
    {name:"Donkey Calf Raise",sets:"3",reps:"15-20",rest:"60 sec",muscle:"calves",cue:"Hinge forward, loads gastroc differently to standing."},
    {name:"Jump Rope",sets:"3",reps:"60 sec",rest:"60 sec",muscle:"calves",cue:"Stay on balls of feet, calves absorb each landing."},
    {name:"Tib Bar Raise",sets:"3",reps:"15-20",rest:"60 sec",muscle:"calves",cue:"Dorsiflexion movement, hits tibialis anterior."},
    {name:"Smith Machine Calf Raise",sets:"4",reps:"15-20",rest:"60 sec",muscle:"calves",cue:"Bar on traps, toes on plate, full ROM."},
    {name:"Barbell Seated Calf Raise",sets:"3",reps:"15-20",rest:"60 sec",muscle:"calves",cue:"Bar across knees, full ROM, isolates soleus."},
  ],
  core:[
    {name:"Plank",sets:"3",reps:"45-60 sec",rest:"60 sec",muscle:"core",cue:"Straight line head to heels, brace abs like a punch is coming."},
    {name:"Cable Crunch",sets:"3",reps:"12-15",rest:"75 sec",muscle:"core",cue:"Crunch down, not pull down — let abs do the work."},
    {name:"Hanging Leg Raise",sets:"3",reps:"10-15",rest:"75 sec",muscle:"core",cue:"Dead hang, raise legs to 90 or higher, control the descent."},
    {name:"Ab Wheel Rollout",sets:"3",reps:"8-12",rest:"90 sec",muscle:"core",cue:"Roll out slow, keep lower back flat, pull back with abs."},
    {name:"Russian Twist",sets:"3",reps:"20-30",rest:"60 sec",muscle:"core",cue:"Feet off floor, rotate fully each side, control the movement."},
    {name:"Decline Sit-Up",sets:"3",reps:"15-20",rest:"60 sec",muscle:"core",cue:"Full ROM, don't use momentum, squeeze abs at top."},
    {name:"Dragon Flag",sets:"3",reps:"6-10",rest:"90 sec",muscle:"core",cue:"Brutally hard. Lower body straight, control every inch."},
    {name:"Dead Bug",sets:"3",reps:"10-12 each",rest:"60 sec",muscle:"core",cue:"Lower back pressed to floor, extend opposite arm and leg."},
    {name:"Side Plank",sets:"3",reps:"30-45 sec each",rest:"60 sec",muscle:"core",cue:"Hip up, straight line, oblique and core stability."},
    {name:"Hollow Hold",sets:"3",reps:"20-30 sec",rest:"60 sec",muscle:"core",cue:"Lower back pressed down, arms overhead, legs out low."},
    {name:"V-Up",sets:"3",reps:"12-15",rest:"60 sec",muscle:"core",cue:"Simultaneous upper and lower body crunch, meet in middle."},
    {name:"Bicycle Crunch",sets:"3",reps:"20-30",rest:"60 sec",muscle:"core",cue:"Elbow to opposite knee, full rotation, slow and controlled."},
    {name:"Landmine Rotation",sets:"3",reps:"10-12 each",rest:"75 sec",muscle:"core",cue:"Arms extended, rotate through core, feet planted."},
    {name:"Cable Woodchop",sets:"3",reps:"12-15 each",rest:"60 sec",muscle:"core",cue:"Rotate from hip to shoulder, core drives the movement."},
    {name:"Toes-to-Bar",sets:"3",reps:"8-12",rest:"90 sec",muscle:"core",cue:"Dead hang, raise straight legs to touch bar."},
    {name:"3/4 Sit-Up",sets:"3",reps:"15-20",rest:"60 sec",muscle:"core",cue:"Don't go all the way back, keep tension on abs."},
    {name:"Alternate Heel Touchers",sets:"3",reps:"20-30",rest:"60 sec",muscle:"core",cue:"Lateral crunch to touch heels, oblique focus."},
  ],
  hiit:[
    {name:"Burpee",sets:"4",reps:"10-15",rest:"60 sec",muscle:"hiit",cue:"Explosive jump up, soft landing, immediate drop to floor."},
    {name:"Box Jump",sets:"4",reps:"8-10",rest:"90 sec",muscle:"hiit",cue:"Full extension on jump, land softly with knees bent."},
    {name:"Mountain Climber",sets:"4",reps:"30 sec",rest:"30 sec",muscle:"hiit",cue:"Hips level, drive knees to chest alternately, fast pace."},
    {name:"Jump Squat",sets:"3",reps:"10-12",rest:"90 sec",muscle:"hiit",cue:"Squat down, explode up, land softly and immediately squat."},
    {name:"Kettlebell Swing",sets:"4",reps:"15-20",rest:"60 sec",muscle:"hiit",cue:"Hip hinge power, not a squat. Bell floats from hip drive."},
    {name:"Sprint Intervals",sets:"6",reps:"20 sec",rest:"40 sec",muscle:"hiit",cue:"Maximum effort each sprint, full recovery between."},
    {name:"Jumping Lunge",sets:"3",reps:"10-12 each",rest:"90 sec",muscle:"hiit",cue:"Explode and switch legs in air, soft landing."},
    {name:"Battle Ropes",sets:"4",reps:"30 sec",rest:"30 sec",muscle:"hiit",cue:"Anchor at base, alternate or simultaneous waves, max effort."},
    {name:"Tuck Jump",sets:"3",reps:"10-12",rest:"90 sec",muscle:"hiit",cue:"Jump and pull knees to chest, land and immediately repeat."},
    {name:"Plank to Push-Up",sets:"3",reps:"10-12",rest:"75 sec",muscle:"hiit",cue:"Alternate between plank and push-up position, core stays tight."},
    {name:"High Knees",sets:"4",reps:"30 sec",rest:"30 sec",muscle:"hiit",cue:"Drive knees above hip height, pump arms, max speed."},
    {name:"Lateral Bound",sets:"3",reps:"10-12 each",rest:"90 sec",muscle:"hiit",cue:"Explosive lateral jump, stick landing, then bound back."},
    {name:"Kettlebell Goblet Squat",sets:"3",reps:"15-20",rest:"60 sec",muscle:"hiit",cue:"Kettlebell at chest, squat deep, elbows inside knees."},
    {name:"Air Bike",sets:"4",reps:"30 sec",rest:"30 sec",muscle:"hiit",cue:"Full body cycling motion, max effort intervals."},
    {name:"Lunge Sprint",sets:"3",reps:"20m",rest:"60 sec",muscle:"hiit",cue:"Walking lunge pace, drive through front heel."},
  ],
};
...
const FOLDER_OVERRIDES = {
  ...
  "Seated Cable Row": "Bent_Over_Barbell_Row",
  "Single-Arm Dumbbell Row": "One-Arm_Kettlebell_Row",
  ...
  "Dumbbell Lateral Raise": "One-Arm_Incline_Lateral_Raise",
  ...
  return(
    <div style={{minHeight:"100vh",background:"#080808",paddingBottom:"100px"}}>
      ...
      <div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:0,
        background:"radial-gradient(ellipse 120% 60% at 50% -10%, rgba(204,255,0,0.12) 0%, transparent 60%)"}}/>
    ...
    return(
      <div style={{minHeight:"100vh",background:"#0a0a0a",paddingBottom:"80px",position:"relative"}}>
        ...
        <div style={{padding:"0 1.1rem",position:"relative",zIndex:1}}>
          ...
          <a href={`https://www.youtube.com/results?search_query=${encodeURIComponent(ex.name+' proper form tutorial')}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:"0.75rem",background:"rgba(255,0,0,0.06)",border:"1px solid rgba(255,0,0,0.18)",borderRadius:"14px",padding:"0.85rem 1rem",textDecoration:"none",marginBottom:"0.75rem",transition:"all 0.15s"}} className="press">
            <div style={{width:"36px",height:"36px",borderRadius:"10px",background:"#FF0000",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
            ...
            <div style={{flex:1}}>
              <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:"0.9rem",textTransform:"uppercase",letterSpacing:"0.06em",color:"#fff"}}>Watch on YouTube</div>
              <div style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.35)",fontFamily:"'Barlow',sans-serif",marginTop:"1px"}}>{ex.name} · proper form tutorial</div>
            </div>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="2" strokeLinecap="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
          </a>
...
// Storage keys
const PK = {
  config:     'fb_prog_config',
  phase1:     'fb_prog_phase1',
  phase2:     'fb_prog_phase2',
  phase3:     'fb_prog_phase3',
  week:       'fb_prog_week',
  day:        'fb_prog_day',
  completed:  'fb_prog_completed',
};

// Safe localStorage helpers
function progGet(key){ try{ return JSON.parse(localStorage.getItem(key)||'null'); }catch{ return null; } }
function progSet(key,val){ try{ localStorage.setItem(key,JSON.stringify(val)); }catch(e){} }
function progClear(){ Object.values(PK).forEach(k=>localStorage.removeItem(k)); }

// Exercise lists by level — prioritises exercises that have gifs
const PROG_EX = {
  beginner:{
    push:['Push-Up','Incline Dumbbell Press','Flat Dumbbell Press','Overhead Press','Close-Grip Push-Up','Dumbbell Lateral Raise','Tricep Pushdown'],
    pull:['Lat Pulldown','Seated Cable Row','Dumbbell Row','Face Pull','Barbell Curl','Hammer Curl'],
    legs:['Goblet Squat','Leg Press','Romanian Deadlift','Leg Extension','Leg Curl','Standing Calf Raise','Glute Bridge'],
    full:['Push-Up','Goblet Squat','Dumbbell Row','Romanian Deadlift','Glute Bridge','Plank'],
  },
  intermediate:{
    push:['Barbell Bench Press','Incline Dumbbell Press','Overhead Press','Cable Chest Fly','Dumbbell Lateral Raise','Skull Crusher','Tricep Pushdown'],
    pull:['Barbell Row','Lat Pulldown','Pull-Up','Seated Cable Row','Face Pull','Barbell Curl','Hammer Curl'],
    legs:['Barbell Back Squat','Romanian Deadlift','Leg Press','Hip Thrust','Leg Extension','Leg Curl','Standing Calf Raise'],
    full:['Barbell Bench Press','Barbell Back Squat','Barbell Row','Overhead Press','Romanian Deadlift','Pull-Up'],
  },
  advanced:{
    push:['Barbell Bench Press','Incline Barbell Press','Cable Chest Fly','Overhead Press','Cable Lateral Raise','Close-Grip Bench Press','Skull Crusher'],
    pull:['Deadlift','Barbell Row','Pull-Up','Lat Pulldown','Seated Cable Row','Face Pull','Preacher Curl','Barbell Curl'],
    legs:['Barbell Back Squat','Romanian Deadlift','Leg Press','Hip Thrust','Leg Extension','Leg Curl','Nordic Curl','Standing Calf Raise'],
...
const PROG_REPS = {
  beginner:{c:'10-12',i:'12-15'},
  intermediate:{c:'8-10',i:'10-12'},
  advanced:{c:'6-8',i:'8-10'},
};

function buildFallbackSessions(days,level,weekNum){
  const ex = PROG_EX[level]||PROG_EX.intermediate;
  const baseS = parseInt(PROG_SETS[level]||4);
  const bonus = weekNum<=4?0:weekNum<=8?1:2;
  const sets = String(Math.min(5,baseS+bonus));
  const reps = PROG_REPS[level]||PROG_REPS.intermediate;
  const SPLITS = {
    3:[{label:'Push',ex:ex.push},{label:'Pull',ex:ex.pull},{label:'Legs',ex:ex.legs}],
    4:[{label:'Push A',ex:ex.push},{label:'Pull A',ex:ex.pull},{label:'Legs',ex:ex.legs},{label:'Push B',ex:[...ex.push.slice(2),...ex.push.slice(0,2)]}],
    5:[{label:'Chest',ex:ex.push},{label:'Back',ex:ex.pull},{label:'Shoulders',ex:ex.push.slice(4)},{label:'Legs',ex:ex.legs},{label:'Arms',ex:[...ex.pull.slice(4),...ex.push.slice(5)]}],
  };
  return (SPLITS[days]||SPLITS[4]).slice(0,days).map((s,i)=>({
    day:`Day ${i+1}`,label:s.label,
    exercises:(s.ex||[]).filter(Boolean).slice(0,5).map(name=>({
      name,sets,
      reps:['Push-Up','Pull-Up'].includes(name)?reps.i:reps.c,
      rest:weekNum<=4?'90 sec':weekNum<=8?'75 sec':'60 sec',
      cue:'',
    }))
  }));
}

// Normalise a week from AI — guarantee it always has valid sessions
function normaliseWeek(raw, weekNum, config){
  if(!raw||typeof raw!=='object') return null;
  const sessions = (raw.sessions||raw.workouts||raw.days||[]).filter(Boolean);
  const normSessions = sessions.length>0
    ? sessions.map((s,i)=>({
        day:s.day||`Day ${i+1}`,
        label:s.label||s.name||s.title||`Session ${i+1}`,
        focus:s.focus||'',
        exercises:(s.exercises||s.workout||[]).filter(Boolean).map(ex=>({
          name:String(ex.name||ex.exercise||'Exercise'),
          sets:String(ex.sets||'3'),
          reps:String(ex.reps||'10-12'),
          rest:String(ex.rest||''),
          cue:String(ex.cue||ex.notes||''),
        }))
      }))
    : buildFallbackSessions(config.days||4, config.level||'intermediate', weekNum);

  return {
    week: weekNum,
    phase: weekNum<=4?'Foundation':weekNum<=8?'Build':'Peak',
    theme: raw.theme||'',
    tip:   raw.tip||'',
    mindset: raw.mindset||'',
...
Rules: exactly ${weekEnd-weekStart+1} weeks numbered ${weekStart}-${weekEnd}, ${config.days} sessions each, 4-5 exercises, ${equipLabel} only, progress each week within this phase`;
  ...
  const res = await fetch('/api/chat',{
    ...
    headers:{'Content-Type':'application/json'},
    body:JSON.stringify({
      system:'You are an elite personal trainer. Return ONLY raw valid JSON starting with {. No markdown. No backticks. No text outside the JSON.',
      messages:[{role:'user',content:prompt}]
    })
  });
  if(!res.ok) throw new Error(`API ${res.status}`);
  const d = await res.json();
  let text = (d.content?.[0]?.text||'').replace(/```json|```/gi,'').trim();
  const s = text.indexOf('{'); const e = text.lastIndexOf('}');
  if(s===-1||e===-1) throw new Error('No JSON');
  const parsed = JSON.parse(text.slice(s,e+1));
  const weeks = (parsed.weeks||[]).filter(Boolean);
  if(!weeks.length) throw new Error('Empty weeks');
  return {
    name: parsed.name||goalLabel,
    tagline: parsed.tagline||'Your personalised transformation',
    weeks: weeks.map((w,i)=>normaliseWeek(w, weekStart+i, config)),
  };
}
...
function ProgrammeSetup({onStart}){
  ...
  const GOALS=[
    {id:'muscle', icon:'💪', name:'Build Muscle', desc:'Add size and strength',accent:'#CCFF00',bg:'rgba(204,255,0,0.08)',border:'rgba(204,255,0,0.3)'},
    {id:'fatloss',icon:'🔥', name:'Burn Fat',     desc:'Lose fat, keep muscle',accent:'#f87171',bg:'rgba(239,68,68,0.08)',border:'rgba(239,68,68,0.3)'},
    {id:'athletic',icon:'⚡',name:'Athletic',      desc:'Speed, power, conditioning',accent:'#60a5fa',bg:'rgba(59,130,246,0.08)',border:'rgba(59,130,246,0.3)'},
  ];
  const selGoal = GOALS.find(g=>g.id===goal)||GOALS[0];

  async function handleGenerate(){
    setLoading(true);setError('');setGenStep(1);
    const cfg = {goal,days,equipment,level};
    try{
      // Generate Phase 1 only — instant start
      const phase1 = await generatePhase(1,cfg,null);
      progSet(PK.config, cfg);
      progSet(PK.phase1, phase1);
      progSet(PK.week,   1);
      progSet(PK.day,    0);
      progSet(PK.completed, []);
      setGenStep(5);
      setTimeout(()=>onStart(cfg),400);
    }catch(e){
      console.error('Phase 1 failed:',e);
      // Fallback — build from database, no AI needed
      const fallback = {
        name: goal==='muscle'?'Muscle Builder':goal==='fatloss'?'Fat Furnace':'Athletic Edge',
        tagline: 'Your personalised 12-week transformation',
        weeks: Array.from({length:4},(_,i)=>({
          week:i+1, phase:'Foundation',
          theme:'Build the base', tip:'Focus on form over weight this week.',
          mindset:'Every rep is a vote for who you want to become.',
          sessions: buildFallbackSessions(days,level,i+1),
        }))
      };
      progSet(PK.config, cfg);
      progSet(PK.phase1, fallback);
      progSet(PK.week, 1);
      progSet(PK.day, 0);
      progSet(PK.completed, []);
      setTimeout(()=>onStart(cfg),400);
  ...
  if(loading){
    const STEPS=['Starting...','Building your Foundation (weeks 1-4)...','Crafting your exercises...','Personalising your programme...','Almost done...'];
    return(
      <div style={{minHeight:'100vh',background:'#0a0a0a',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'2rem',position:'relative'}}>
        ...
        <style>{`
          ...
          @keyframes earWiggle{0%,100%{transform:rotate(0deg)}25%{transform:rotate(-20deg)}75%{transform:rotate(20deg)}}
        ...
        <div style={{position:'relative',zIndex:1,textAlign:'center',width:'100%',maxWidth:'360px'}}>
          <div style={{position:'relative',display:'inline-block',marginBottom:'1.5rem',animation:'robotBounce 1.8s ease-in-out infinite'}}>
            <div style={{position:'absolute',top:'6px',left:'-14px',width:'10px',height:'22px',background:'rgba(204,255,0,0.25)',borderRadius:'4px',animation:'earWiggle 0.9s ease-in-out infinite'}}/>
            <div style={{position:'absolute',top:'6px',right:'-14px',width:'10px',height:'22px',background:'rgba(204,255,0,0.25)',borderRadius:'4px',animation:'earWiggle 0.9s ease-in-out infinite 0.15s'}}/>
            <div style={{fontSize:'3.5rem',lineHeight:1}}>🤖</div>
          </div>
          <div style={{fontSize:'2rem',fontWeight:900,fontFamily:"'Barlow Condensed',sans-serif",textTransform:'uppercase',color:'#fff',lineHeight:1,marginBottom:'0.4rem'}}>Building Your<br/><span style={{color:'#CCFF00'}}>Programme</span></div>
          <div style={{fontSize:'0.85rem',color:'rgba(255,255,255,0.35)',fontFamily:"'Barlow',sans-serif",marginBottom:'2rem',lineHeight:1.6}}>Claude is personalising your first 4 weeks.<br/>Takes about 20 seconds.</div>
          <div style={{background:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:'16px',padding:'1rem',width:'100%'}}>
            {STEPS.map((step,i)=>(
              <div key={i} style={{display:'flex',alignItems:'center',gap:'0.75rem',padding:'0.45rem 0',borderBottom:i<STEPS.length-1?'1px solid rgba(255,255,255,0.05)':'none',animation:i===genStep?'stepFade 0.3s ease':'none'}}>
                <div style={{width:'22px',height:'22px',borderRadius:'50%',flexShrink:0,display:'flex',alignItems:'center',justifyContent:'center',
                  background:i<genStep?'rgba(204,255,0,0.2)':i===genStep?'rgba(204,255,0,0.1)':'rgba(255,255,255,0.05)',
                  border:`1px solid ${i<genStep?'rgba(204,255,0,0.5)':i===genStep?'rgba(204,255,0,0.35)':'rgba(255,255,255,0.08)'}`,
                  animation:i===genStep?'stepSpin 1.2s linear infinite':'none',
                }}>
                  {i<genStep&&<span style={{color:'#CCFF00',fontSize:'0.7rem'}}>✓</span>}
                  {i===genStep&&<span style={{color:'#CCFF00',fontSize:'0.65rem'}}>↻</span>}
                </div>
                <span style={{fontSize:'0.82rem',fontFamily:"'Barlow',sans-serif",
                  color:i<genStep?'rgba(255,255,255,0.4)':i===genStep?'#fff':'rgba(255,255,255,0.18)',
                  textDecoration:i<genStep?'line-through':'none',transition:'color 0.3s',
                }}>{step}</span>
                {i===genStep&&<div style={{marginLeft:'auto',width:'5px',height:'5px',borderRadius:'50%',background:'#CCFF00',flexShrink:0,animation:'pulse 1s ease-in-out infinite'}}/>}
              </div>
            ))}
          </div>
        </div>
  ...
  return(
    <div style={{minHeight:'100vh',background:'#0a0a0a',padding:'1.5rem 1.25rem 3rem',position:'relative'}}>
      <div style={{position:'absolute',inset:0,background:`radial-gradient(ellipse 90% 45% at 50% 0%,${selGoal.bg} 0%,transparent 55%)`,pointerEvents:'none',transition:'background 0.4s'}}/>
      <div style={{maxWidth:'440px',margin:'0 auto',position:'relative',zIndex:1}}>

        <div style={{textAlign:'center',marginBottom:'2rem',animation:'fadeUp 0.5s ease both'}}>
          <div style={{fontSize:'0.65rem',fontWeight:800,letterSpacing:'0.18em',textTransform:'uppercase',color:'rgba(255,255,255,0.3)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'0.5rem'}}>AI-Personalised For You</div>
          <div style={{fontSize:'2.8rem',fontWeight:900,fontFamily:"'Barlow Condensed',sans-serif",textTransform:'uppercase',color:'#fff',lineHeight:0.9,marginBottom:'0.5rem'}}>12-WEEK<br/><span style={{color:selGoal.accent}}>PROGRAMME</span></div>
          <div style={{fontSize:'0.88rem',color:'rgba(255,255,255,0.4)',fontFamily:"'Barlow',sans-serif"}}>Answer 4 questions. Claude builds your plan.</div>
        </div>

        {/* Goal */}
        <div style={{marginBottom:'1.25rem',animation:'fadeUp 0.5s ease 0.05s both'}}>
          <div style={{fontSize:'0.68rem',fontWeight:800,letterSpacing:'0.12em',textTransform:'uppercase',color:'rgba(255,255,255,0.4)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'0.6rem'}}>Your Goal</div>
          {GOALS.map(g=>(
            <div key={g.id} onClick={()=>setGoal(g.id)} style={{display:'flex',alignItems:'center',gap:'1rem',background:goal===g.id?g.bg:'rgba(255,255,255,0.03)',backdropFilter:'blur(15px)',border:`2px solid ${goal===g.id?g.border:'rgba(255,255,255,0.07)'}`,borderRadius:'18px',padding:'1rem 1.1rem',cursor:'pointer',marginBottom:'0.5rem',transition:'all 0.2s',boxShadow:goal===g.id?`0 4px 24px ${g.accent}18`:'none'}}>
              <div style={{width:'44px',height:'44px',borderRadius:'12px',background:goal===g.id?g.bg:'rgba(255,255,255,0.06)',border:`1px solid ${goal===g.id?g.border:'rgba(255,255,255,0.08)'}`,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,fontSize:'1.3rem',transition:'all 0.2s'}}>{g.icon}</div>
              <div style={{flex:1}}>
              ...
              <div style={{width:'22px',height:'22px',borderRadius:'50%',background:goal===g.id?g.accent:'rgba(255,255,255,0.08)',border:`2px solid ${goal===g.id?g.accent:'rgba(255,255,255,0.15)'}`,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,transition:'all 0.2s'}}>
                {goal===g.id&&<svg width="10" height="10" viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3" fill="none" stroke="#000" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>}
              </div>
            </div>
          ))}
        </div>
        ...
        {/* Days */}
        <div style={{marginBottom:'1.25rem',animation:'fadeUp 0.5s ease 0.1s both'}}>
          <div style={{fontSize:'0.68rem',fontWeight:800,letterSpacing:'0.12em',textTransform:'uppercase',color:'rgba(255,255,255,0.4)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'0.6rem'}}>Days Per Week</div>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'0.5rem'}}>
            {[{n:3,label:'Focused'},{n:4,label:'Optimal'},{n:5,label:'Intense'}].map(d=>(
              <button key={d.n} onClick={()=>setDays(d.n)} style={{padding:'1rem 0.5rem',background:days===d.n?`${selGoal.bg}`:'rgba(255,255,255,0.04)',border:`2px solid ${days===d.n?selGoal.border:'rgba(255,255,255,0.07)'}`,borderRadius:'14px',cursor:'pointer',textAlign:'center',transition:'all 0.2s'}}>
                <div style={{fontSize:'2rem',fontWeight:900,color:days===d.n?selGoal.accent:'rgba(255,255,255,0.5)',fontFamily:"'Barlow Condensed',sans-serif",lineHeight:1}}>{d.n}</div>
                <div style={{fontSize:'0.62rem',color:days===d.n?selGoal.accent:'rgba(255,255,255,0.25)',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:800,textTransform:'uppercase',letterSpacing:'0.06em',marginTop:'3px'}}>{d.label}</div>
              </button>
            ))}
          </div>
        </div>
        ...
        {/* Equipment */}
        <div style={{marginBottom:'1.25rem',animation:'fadeUp 0.5s ease 0.15s both'}}>
          <div style={{fontSize:'0.68rem',fontWeight:800,letterSpacing:'0.12em',textTransform:'uppercase',color:'rgba(255,255,255,0.4)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'0.6rem'}}>Where You Train</div>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'0.5rem'}}>
            {[{id:'gym',icon:'🏋️',label:'Gym',desc:'Full equipment'},{id:'home',icon:'🏠',label:'Home',desc:'Dumbbells & bodyweight'}].map(e=>(
              <button key={e.id} onClick={()=>setEquipment(e.id)} style={{padding:'1.1rem',background:equipment===e.id?selGoal.bg:'rgba(255,255,255,0.04)',border:`2px solid ${equipment===e.id?selGoal.border:'rgba(255,255,255,0.07)'}`,borderRadius:'14px',cursor:'pointer',textAlign:'center',transition:'all 0.2s'}}>
                <div style={{fontSize:'1.8rem',marginBottom:'0.25rem'}}>{e.icon}</div>
                <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,textTransform:'uppercase',fontSize:'0.85rem',color:equipment===e.id?selGoal.accent:'rgba(255,255,255,0.5)'}}>{e.label}</div>
        ...
        {/* Level */}
        <div style={{marginBottom:'1.75rem',animation:'fadeUp 0.5s ease 0.2s both'}}>
          <div style={{fontSize:'0.68rem',fontWeight:800,letterSpacing:'0.12em',textTransform:'uppercase',color:'rgba(255,255,255,0.4)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'0.6rem'}}>Experience Level</div>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'0.5rem'}}>
            {[{id:'beginner',icon:'🌱',label:'Beginner',desc:'0-1 years'},{id:'intermediate',icon:'💪',label:'Intermediate',desc:'1-3 years'},{id:'advanced',icon:'👑',label:'Advanced',desc:'3+ years'}].map(l=>(
              <button key={l.id} onClick={()=>setLevel(l.id)} style={{padding:'0.9rem 0.4rem',background:level===l.id?selGoal.bg:'rgba(255,255,255,0.04)',border:`2px solid ${level===l.id?selGoal.border:'rgba(255,255,255,0.07)'}`,borderRadius:'14px',cursor:'pointer',textAlign:'center',transition:'all 0.2s'}}>
                <div style={{fontSize:'1.4rem',marginBottom:'0.2rem'}}>{l.icon}</div>
                <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:800,textTransform:'uppercase',fontSize:'0.68rem',color:level===l.id?selGoal.accent:'rgba(255,255,255,0.35)',letterSpacing:'0.04em'}}>{l.label}</div>
        ...
        {error&&<div style={{background:'rgba(255,60,60,0.08)',border:'1px solid rgba(255,60,60,0.2)',borderRadius:'12px',padding:'0.75rem 1rem',marginBottom:'0.75rem',fontSize:'0.82rem',color:'rgba(255,120,120,0.9)',fontFamily:"'Barlow',sans-serif"}}>{error}</div>}

        <button onClick={handleGenerate} style={{width:'100%',padding:'1.1rem',background:selGoal.accent,color:selGoal.accent==="#CCFF00"?'#000':'#fff',border:'none',borderRadius:'14px',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'1rem',letterSpacing:'0.08em',textTransform:'uppercase',cursor:'pointer',boxShadow:`0 0 40px ${selGoal.accent}25`,transition:'all 0.2s',animation:'fadeUp 0.5s ease 0.25s both'}}>
          Generate My Programme →
        </button>
        <p style={{textAlign:'center',color:'rgba(255,255,255,0.2)',fontSize:'0.72rem',fontFamily:"'Barlow',sans-serif",marginTop:'0.6rem'}}>AI-personalised · Phase 1 ready in ~20 seconds · More phases unlock as you progress</p>
      </div>
    </div>
  );
}
...
// ─── PHASE UNLOCK BUTTON ──────────────────────────────────────────────────────
function PhaseUnlockCard({phaseNum,config,onUnlocked}){
  const[loading,setLoading]=useState(false);
  const[error,setError]=useState('');
  const phaseLabel=phaseNum===2?'Build Phase (Weeks 5-8)':'Peak Phase (Weeks 9-12)';
  const prevPhaseKey=phaseNum===2?PK.phase1:PK.phase2;

  async function unlock(){
    setLoading(true);setError('');
    try{
      const prevPhase=progGet(prevPhaseKey);
      const prevWeeks=prevPhase?.weeks||[];
      const phase=await generatePhase(phaseNum,config,prevWeeks);
      progSet(phaseNum===2?PK.phase2:PK.phase3,phase);
      onUnlocked();
    }catch(e){
  ...
  if(loading) return(
    <div style={{background:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)',borderRadius:'20px',padding:'1.5rem',textAlign:'center',marginBottom:'0.75rem'}}>
      <div style={{fontSize:'2rem',marginBottom:'0.5rem',animation:'robotBounce 1.8s ease-in-out infinite'}}>🤖</div>
      <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,textTransform:'uppercase',fontSize:'1rem',color:'#fff',marginBottom:'0.25rem'}}>Building {phaseLabel}...</div>
      <div style={{fontSize:'0.78rem',color:'rgba(255,255,255,0.4)',fontFamily:"'Barlow',sans-serif"}}>Claude is analysing your progress</div>
      <LoadingDots/>
    </div>
  );

  return(
    <div style={{background:'linear-gradient(135deg,rgba(168,85,247,0.1),rgba(99,102,241,0.06))',border:'1px solid rgba(168,85,247,0.25)',borderRadius:'20px',padding:'1.25rem',marginBottom:'0.75rem',position:'relative',overflow:'hidden'}}>
      <div style={{position:'absolute',top:'-20px',right:'-20px',width:'80px',height:'80px',borderRadius:'50%',background:'rgba(168,85,247,0.08)',filter:'blur(20px)',pointerEvents:'none'}}/>
      <div style={{fontSize:'0.6rem',fontWeight:800,letterSpacing:'0.15em',textTransform:'uppercase',color:'#c084fc',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'6px'}}>🔓 Phase Unlocked</div>
      <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,textTransform:'uppercase',fontSize:'1.2rem',color:'#fff',marginBottom:'4px'}}>{phaseLabel}</div>
      <div style={{fontSize:'0.78rem',color:'rgba(255,255,255,0.45)',fontFamily:"'Barlow',sans-serif",marginBottom:'1rem',lineHeight:1.5}}>You've completed the previous phase. Let Claude build your next 4 weeks based on your progress.</div>
      {error&&<div style={{fontSize:'0.78rem',color:'rgba(255,100,100,0.8)',fontFamily:"'Barlow',sans-serif",marginBottom:'0.75rem'}}>{error}</div>}
      <button onClick={unlock} style={{width:'100%',padding:'0.9rem',background:'#c084fc',color:'#000',border:'none',borderRadius:'12px',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'0.9rem',letterSpacing:'0.08em',textTransform:'uppercase',cursor:'pointer'}}>
        Generate {phaseLabel} →
      </button>
    </div>
  );
...
// ─── PROGRAMME SCREEN ─────────────────────────────────────────────────────────
class ProgrammeErrorBoundary extends React.Component{
  constructor(p){super(p);this.state={err:null};}
  static getDerivedStateFromError(e){return{err:e};}
  componentDidCatch(e,i){console.error('Programme crash:',e,i);}
  render(){
    if(this.state.err) return(
      <div style={{minHeight:'100vh',background:'#0a0a0a',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'2rem',textAlign:'center'}}>
        ...
        <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,textTransform:'uppercase',fontSize:'1.3rem',color:'#fff',marginBottom:'0.5rem'}}>Something crashed</div>
        <div style={{fontSize:'0.82rem',color:'rgba(255,255,255,0.4)',fontFamily:"'Barlow',sans-serif",marginBottom:'1.5rem'}}>{this.state.err?.message}</div>
        <button onClick={()=>{progClear();this.setState({err:null});}} style={{padding:'0.75rem 2rem',background:'#CCFF00',color:'#000',border:'none',borderRadius:'10px',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'0.9rem',textTransform:'uppercase',cursor:'pointer'}}>Reset & Start Fresh</button>
      </div>
    );
...
function ProgrammeScreen({onStartWorkout}){
  const[config,setConfig]=useState(()=>progGet(PK.config));
  const[currentWeek,setCurrentWeek]=useState(()=>progGet(PK.week)||1);
  const[currentDay,setCurrentDay]=useState(()=>progGet(PK.day)||0);
  const[completed,setCompleted]=useState(()=>progGet(PK.completed)||[]);
  const[showDay,setShowDay]=useState(null);
  const[showComplete,setShowComplete]=useState(false);
  const[, forceUpdate]=useState(0);

  function startProgramme(cfg){
    setConfig(cfg);setCurrentWeek(1);setCurrentDay(0);setCompleted([]);
    forceUpdate(n=>n+1);
  }

  // Get all weeks across all phases
  function getAllWeeks(){
    const p1=(progGet(PK.phase1)?.weeks||[]);
    const p2=(progGet(PK.phase2)?.weeks||[]);
    const p3=(progGet(PK.phase3)?.weeks||[]);
    return [...p1,...p2,...p3];
  }

  function getWorkoutsForWeek(weekNum){
    const all=getAllWeeks();
    const wk=all.find(w=>w?.week===weekNum);
    if(wk?.sessions?.length>0) return wk.sessions;
    return buildFallbackSessions(config?.days||4,config?.level||'intermediate',weekNum);
  }

  function markDone(weekNum,dayIdx){
    const key=`w${weekNum}d${dayIdx}`;
    if(completed.includes(key)) return;
    const updated=[...completed,key];
    setCompleted(updated);
    progSet(PK.completed,updated);
    const workouts=getWorkoutsForWeek(weekNum);
    if(dayIdx<workouts.length-1){
      const next=dayIdx+1;
      setCurrentDay(next);progSet(PK.day,next);
    }else if(weekNum<12){
      const nw=weekNum+1;
      setCurrentWeek(nw);setCurrentDay(0);
      progSet(PK.week,nw);progSet(PK.day,0);
    }else{setShowComplete(true);}
    setShowDay(null);
  }

  function reset(){progClear();setConfig(null);setCurrentWeek(1);setCurrentDay(0);setCompleted([]);setShowDay(null);setShowComplete(false);}

  if(!config) return <ProgrammeSetup onStart={startProgramme}/>;

  const GOAL_STYLE={
    muscle: {accent:'#CCFF00',bg:'rgba(204,255,0,0.1)',  border:'rgba(204,255,0,0.25)',  glow:'rgba(204,255,0,0.15)'},
    fatloss:{accent:'#f87171',bg:'rgba(239,68,68,0.1)',   border:'rgba(239,68,68,0.25)',  glow:'rgba(239,68,68,0.15)'},
    athletic:{accent:'#60a5fa',bg:'rgba(59,130,246,0.1)', border:'rgba(59,130,246,0.25)', glow:'rgba(59,130,246,0.15)'},
  };
  const GS=GOAL_STYLE[config?.goal]||GOAL_STYLE.muscle;
  const phase1=progGet(PK.phase1);
  const phase2=progGet(PK.phase2);
  const phase3=progGet(PK.phase3);
  const allWeeks=getAllWeeks();
  const totalWeeks=allWeeks.length||4;
  const totalSessions=totalWeeks*(config?.days||4);
  const completedCount=completed.length;
  const progressPct=totalSessions>0?Math.round((completedCount/totalSessions)*100):0;
  const currentWeekData=allWeeks.find(w=>w?.week===currentWeek);
  const phase=currentWeekData?.phase||(currentWeek<=4?'Foundation':currentWeek<=8?'Build':'Peak');
  const workouts=getWorkoutsForWeek(currentWeek);
  const todayWorkout=workouts[currentDay]||workouts[0]||{label:'Session',exercises:[]};

  // Phase unlock logic
  const phase2Unlocked=completedCount>=(4*(config?.days||4));
  const phase3Unlocked=completedCount>=(8*(config?.days||4));
  const needsPhase2=phase2Unlocked&&!phase2&&currentWeek>4;
  const needsPhase3=phase3Unlocked&&!phase3&&currentWeek>8;
    ...
    return(
      <div style={{minHeight:'100vh',background:'#0a0a0a',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'2rem',position:'relative',textAlign:'center'}}>
        ...
        <div style={{position:'relative',zIndex:1,width:'100%',maxWidth:'380px'}}>
          <div style={{background:'rgba(255,255,255,0.05)',backdropFilter:'blur(30px)',border:'1px solid rgba(204,255,0,0.25)',borderRadius:'24px',padding:'2rem 1.5rem',marginBottom:'1.25rem',animation:'scaleIn 0.5s cubic-bezier(0.34,1.56,0.64,1)'}}>
            ...
            <div style={{fontSize:'4rem',marginBottom:'0.75rem',animation:'float 3s ease-in-out infinite'}}>🏆</div>
            <div style={{fontSize:'0.85rem',color:'rgba(255,255,255,0.35)',fontFamily:"'Barlow',sans-serif",marginBottom:'0.25rem'}}>This certifies that</div>
            ...
            <div style={{fontSize:'0.85rem',color:'rgba(255,255,255,0.35)',fontFamily:"'Barlow',sans-serif",marginBottom:'1rem'}}>has completed the full 12-week programme</div>
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'0.5rem',marginBottom:'1rem'}}>
              {[{n:'12',l:'Weeks'},{n:completedCount,l:'Sessions'},{n:'100%',l:'Complete'}].map((x,i)=>(
          ...
          <button onClick={async()=>{const txt=`I just completed the ForgeBody 12-Week Programme! 💪🏆
${completedCount} sessions. Zero excuses.
Start yours → forgebody.fit`;try{if(navigator.share)await navigator.share({title:'ForgeBody Certificate',text:txt});else await navigator.clipboard.writeText(txt);}catch(e){}}} style={{width:'100%',padding:'0.9rem',background:'rgba(255,255,255,0.07)',border:'1px solid rgba(255,255,255,0.12)',borderRadius:'12px',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'0.88rem',letterSpacing:'0.06em',textTransform:'uppercase',cursor:'pointer',color:'#fff',marginBottom:'0.5rem'}}>Share My Achievement 📤</button>
          <button onClick={reset} style={{width:'100%',padding:'1rem',background:'#CCFF00',color:'#000',border:'none',borderRadius:'12px',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'0.95rem',letterSpacing:'0.08em',textTransform:'uppercase',cursor:'pointer'}}>Start New Programme →</button>
        </div>
      </div>
    );
  }
  ...
  return(
    <div style={{minHeight:'100vh',background:'#0a0a0a',padding:'0 0 5rem',position:'relative'}}>
      <div style={{position:'absolute',inset:0,background:`radial-gradient(ellipse 110% 30% at 50% 0%,${GS.bg} 0%,transparent 45%)`,pointerEvents:'none'}}/>
      <div style={{maxWidth:'440px',margin:'0 auto',padding:'1.5rem 1.25rem 0',position:'relative',zIndex:1}}>

        {/* Header */}
        <div style={{marginBottom:'1.25rem',animation:'fadeUp 0.4s ease'}}>
          <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.18em',textTransform:'uppercase',color:'rgba(255,255,255,0.3)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'4px'}}>12-Week Transformation</div>
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
            <div>
              <div style={{fontSize:'2.2rem',fontWeight:900,fontFamily:"'Barlow Condensed',sans-serif",textTransform:'uppercase',color:'#fff',lineHeight:0.95,letterSpacing:'-0.5px'}}>{phase1?.name||'Your Programme'}</div>
              <div style={{fontSize:'0.78rem',color:'rgba(255,255,255,0.4)',fontFamily:"'Barlow',sans-serif",marginTop:'4px'}}>{phase1?.tagline||''}</div>
            </div>
        ...
        <div style={{background:'rgba(255,255,255,0.05)',backdropFilter:'blur(20px)',border:`1px solid ${GS.border}`,borderRadius:'20px',padding:'1.1rem 1.25rem',marginBottom:'0.75rem',animation:'fadeUp 0.4s ease 0.05s both'}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'8px'}}>
            <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.15em',textTransform:'uppercase',color:GS.accent,fontFamily:"'Barlow Condensed',sans-serif"}}>Overall Progress</div>
          ...
          <div style={{height:'5px',background:'rgba(255,255,255,0.08)',borderRadius:'3px',overflow:'hidden',marginBottom:'8px'}}>
            <div style={{height:'100%',width:`${progressPct}%`,background:`linear-gradient(90deg,${GS.accent},${GS.accent}bb)`,borderRadius:'3px',transition:'width 0.8s ease',boxShadow:`0 0 10px ${GS.glow}`}}/>
          </div>
          <div style={{display:'flex',justifyContent:'space-between'}}>
            <span style={{fontSize:'0.65rem',color:'rgba(255,255,255,0.3)',fontFamily:"'Barlow',sans-serif"}}>{completedCount} of {totalSessions} sessions</span>
            <span style={{fontSize:'0.65rem',color:'rgba(255,255,255,0.2)',fontFamily:"'Barlow',sans-serif"}}>{totalSessions-completedCount} to go</span>
          </div>
        </div>

        {/* Phase + week cards */}
        <div style={{display:'flex',gap:'0.5rem',marginBottom:'0.75rem',animation:'fadeUp 0.4s ease 0.1s both'}}>
          <div style={{background:GS.bg,border:`1px solid ${GS.border}`,borderRadius:'14px',padding:'0.75rem 1rem',flex:1,boxShadow:`0 4px 20px ${GS.glow}`}}>
            <div style={{fontSize:'0.55rem',fontWeight:800,letterSpacing:'0.15em',textTransform:'uppercase',color:GS.accent,fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'3px'}}>{phase} Phase</div>
            <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'1.3rem',textTransform:'uppercase',color:'#fff',lineHeight:1}}>Week {currentWeek}</div>
            <div style={{fontSize:'0.68rem',color:'rgba(255,255,255,0.35)',fontFamily:"'Barlow',sans-serif",marginTop:'3px'}}>of {totalWeeks} weeks</div>
          </div>
          <div style={{background:'rgba(255,255,255,0.04)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:'14px',padding:'0.75rem 1rem',flex:1}}>
            <div style={{fontSize:'0.55rem',fontWeight:800,letterSpacing:'0.15em',textTransform:'uppercase',color:'rgba(255,255,255,0.3)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'3px'}}>This Week</div>
            <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'1.3rem',color:'#fff',lineHeight:1}}>{workouts.filter((_,i)=>completed.includes(`w${currentWeek}d${i}`)).length}/{workouts.length}</div>
            <div style={{fontSize:'0.68rem',color:'rgba(255,255,255,0.35)',fontFamily:"'Barlow',sans-serif",marginTop:'3px'}}>sessions done</div>
          </div>
        </div>

        {/* Phase unlock cards */}
        {needsPhase2&&<PhaseUnlockCard phaseNum={2} config={config} onUnlocked={()=>forceUpdate(n=>n+1)}/>}
        {needsPhase3&&<PhaseUnlockCard phaseNum={3} config={config} onUnlocked={()=>forceUpdate(n=>n+1)}/>}

        {/* TODAY hero card */}
        <div style={{background:`linear-gradient(145deg,${GS.bg},rgba(0,0,0,0.5))`,backdropFilter:'blur(20px)',border:`1px solid ${GS.border}`,borderRadius:'22px',padding:'1.3rem',marginBottom:'0.75rem',position:'relative',overflow:'hidden',animation:'fadeUp 0.4s ease 0.15s both',boxShadow:`0 8px 32px ${GS.glow}`}}>
          <div style={{position:'absolute',top:'-25px',right:'-25px',width:'90px',height:'90px',borderRadius:'50%',background:GS.bg,filter:'blur(20px)',pointerEvents:'none'}}/>
          <div style={{display:'flex',alignItems:'center',gap:'6px',marginBottom:'10px'}}>
            <div style={{width:'6px',height:'6px',borderRadius:'50%',background:GS.accent,boxShadow:`0 0 8px ${GS.accent}`,animation:'pulse 2s ease-in-out infinite'}}/>
            <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.18em',textTransform:'uppercase',color:GS.accent,fontFamily:"'Barlow Condensed',sans-serif"}}>Today's Session</div>
          </div>
          <div style={{fontSize:'2rem',fontWeight:900,fontFamily:"'Barlow Condensed',sans-serif",textTransform:'uppercase',color:'#fff',lineHeight:1,marginBottom:'4px',letterSpacing:'-0.3px'}}>{todayWorkout?.label||'Session'}</div>
          <div style={{fontSize:'0.78rem',color:'rgba(255,255,255,0.45)',fontFamily:"'Barlow',sans-serif",marginBottom:'1rem'}}>{(todayWorkout?.exercises||[]).length} exercises · Session {currentDay+1} of {workouts.length}</div>
          <button onClick={()=>setShowDay(currentDay)} style={{width:'100%',padding:'0.95rem',background:GS.accent,color:GS.accent==='#CCFF00'?'#000':'#fff',border:'none',borderRadius:'12px',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'0.92rem',letterSpacing:'0.06em',textTransform:'uppercase',cursor:'pointer',position:'relative',zIndex:1,transition:'transform 0.12s ease'}} className="press">
            {completed.includes(`w${currentWeek}d${currentDay}`)?"View Next Session →":"Start Session →"}
          </button>
        </div>

        {/* Sessions this week */}
        <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.18em',textTransform:'uppercase',color:'rgba(255,255,255,0.25)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'8px'}}>This Week</div>
        {workouts.map((w,i)=>{
          const key=`w${currentWeek}d${i}`;
          const done=completed.includes(key);
          const curr=i===currentDay&&!done;
          return(
            <div key={i} onClick={()=>setShowDay(i)} className="press card-anim" style={{animationDelay:`${i*0.04}s`,display:'flex',alignItems:'center',gap:'0.75rem',background:curr?GS.bg:done?'rgba(255,255,255,0.02)':'rgba(255,255,255,0.04)',border:`1px solid ${curr?GS.border:done?'rgba(255,255,255,0.04)':'rgba(255,255,255,0.07)'}`,borderRadius:'14px',padding:'0.85rem 1rem',marginBottom:'0.4rem',cursor:'pointer',transition:'border-color 0.15s'}}>
              <div style={{width:'30px',height:'30px',borderRadius:'8px',background:done?`${GS.accent}20`:curr?`${GS.accent}15`:'rgba(255,255,255,0.06)',border:`1px solid ${done?GS.accent:curr?`${GS.accent}50`:'rgba(255,255,255,0.08)'}`,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,transition:'all 0.2s'}}>
                {done?<span style={{color:GS.accent,fontSize:'0.75rem',fontWeight:900}}>✓</span>:<span style={{color:curr?GS.accent:'rgba(255,255,255,0.2)',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'0.8rem'}}>{i+1}</span>}
              </div>
              <div style={{flex:1}}>
                <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,textTransform:'uppercase',fontSize:'0.9rem',color:done?'rgba(255,255,255,0.3)':'#fff',textDecoration:done?'line-through':'none'}}>{w.label}</div>
                <div style={{fontSize:'0.65rem',color:'rgba(255,255,255,0.25)',fontFamily:"'Barlow',sans-serif"}}>{(w.exercises||[]).length} exercises</div>
              </div>
              <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:800,fontSize:'0.6rem',textTransform:'uppercase',letterSpacing:'0.1em',color:curr?GS.accent:done?'rgba(255,255,255,0.15)':'rgba(255,255,255,0.08)'}}>
                {curr?'TODAY →':done?'DONE':''}
              </div>
            </div>
          );
        })}
        ...
        {/* Week tip */}
        {currentWeekData?.tip&&(
          <div style={{background:'rgba(255,255,255,0.04)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:'18px',padding:'1rem 1.1rem',marginTop:'0.75rem',animation:'fadeUp 0.4s ease 0.3s both'}}>
            <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.15em',textTransform:'uppercase',color:GS.accent,fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'6px'}}>💡 Week {currentWeek} Focus</div>
            <div style={{fontSize:'0.88rem',color:'rgba(255,255,255,0.6)',fontFamily:"'Barlow',sans-serif",lineHeight:1.65}}>{currentWeekData.tip}</div>
          </div>
        )}

        {/* Mindset */}
        {currentWeekData?.mindset&&(
          <div style={{background:'rgba(168,85,247,0.06)',border:'1px solid rgba(168,85,247,0.18)',borderRadius:'18px',padding:'1rem 1.1rem',marginTop:'0.65rem',animation:'fadeUp 0.4s ease 0.35s both'}}>
            <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.15em',textTransform:'uppercase',color:'#c084fc',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'6px'}}>🧠 Mindset</div>
            <div style={{fontSize:'0.88rem',color:'rgba(255,255,255,0.5)',fontFamily:"'Barlow',sans-serif",lineHeight:1.65,fontStyle:'italic'}}>"{currentWeekData.mindset}"</div>
          </div>
        )}

        {/* 12-week grid */}
        <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.18em',textTransform:'uppercase',color:'rgba(255,255,255,0.2)',fontFamily:"'Barlow Condensed',sans-serif",margin:'1.1rem 0 8px'}}>Programme Overview</div>
        <div style={{display:'grid',gridTemplateColumns:'repeat(12,1fr)',gap:'4px',marginBottom:'6px'}}>
          {Array.from({length:12},(_,i)=>{
            const wk=i+1;
            const d=config?.days||4;
            const wkDone=Array.from({length:d},(_,j)=>completed.includes(`w${wk}d${j}`)).every(Boolean);
            const wkCurr=wk===currentWeek;
            const wkAvail=wk<=totalWeeks;
            return(
              <div key={i} onClick={()=>{if(wkAvail){setCurrentWeek(wk);setCurrentDay(0);}}} style={{aspectRatio:'1',borderRadius:'6px',background:wkDone?GS.accent:wkCurr?`${GS.accent}22`:wkAvail?'rgba(255,255,255,0.06)':'rgba(255,255,255,0.03)',border:`1px solid ${wkCurr?GS.accent:wkDone?'transparent':'rgba(255,255,255,0.05)'}`,display:'flex',alignItems:'center',justifyContent:'center',cursor:wkAvail?'pointer':'default',transition:'all 0.15s'}}>
                <span style={{fontSize:'0.52rem',fontWeight:900,color:wkDone?'#000':wkCurr?GS.accent:wkAvail?'rgba(255,255,255,0.3)':'rgba(255,255,255,0.1)',fontFamily:"'Barlow Condensed',sans-serif"}}>{wk}</span>
              </div>
            );
          })}
        </div>
        <div style={{fontSize:'0.62rem',color:'rgba(255,255,255,0.18)',fontFamily:"'Barlow',sans-serif",textAlign:'center',marginBottom:'0.5rem'}}>Tap any week to navigate · Phases unlock as you progress</div>
      </div>
    </div>
  );
}
...
function ProgrammeHomeCard({onNavigate}){
  const config=progGet(PK.config);
  const currentWeek=progGet(PK.week)||1;
  const currentDay=progGet(PK.day)||0;
  const completed=progGet(PK.completed)||[];
  const phase1=progGet(PK.phase1);

  const GOAL_STYLE={
    muscle: {accent:'#CCFF00',bg:'rgba(204,255,0,0.08)',  border:'rgba(204,255,0,0.2)',  glow:'rgba(204,255,0,0.12)',icon:'💪'},
    fatloss:{accent:'#f87171',bg:'rgba(239,68,68,0.08)',   border:'rgba(239,68,68,0.2)',  glow:'rgba(239,68,68,0.12)', icon:'🔥'},
    athletic:{accent:'#60a5fa',bg:'rgba(59,130,246,0.08)', border:'rgba(59,130,246,0.2)', glow:'rgba(59,130,246,0.12)',icon:'⚡'},
  };

  if(!config){
    return(
      <div onClick={()=>onNavigate('sidebar','programme')} className="press" style={{background:'linear-gradient(135deg,rgba(204,255,0,0.09),rgba(0,0,0,0.4))',backdropFilter:'blur(20px)',border:'1px solid rgba(204,255,0,0.22)',borderRadius:'22px',padding:'1.25rem',marginBottom:'0.75rem',cursor:'pointer',position:'relative',overflow:'hidden',animation:'fadeUp 0.5s ease both',boxShadow:'0 8px 32px rgba(204,255,0,0.08)'}}>
        <div style={{position:'absolute',top:'-20px',right:'-20px',width:'90px',height:'90px',borderRadius:'50%',background:'rgba(204,255,0,0.06)',filter:'blur(25px)',pointerEvents:'none'}}/>
        <div style={{display:'flex',alignItems:'center',gap:'1rem',marginBottom:'1rem'}}>
          <div style={{width:'50px',height:'50px',borderRadius:'14px',background:'rgba(204,255,0,0.12)',border:'1px solid rgba(204,255,0,0.25)',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,fontSize:'1.5rem',animation:'float 3s ease-in-out infinite'}}>📋</div>
          <div style={{flex:1}}>
            <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.18em',textTransform:'uppercase',color:'rgba(255,255,255,0.3)',fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'2px'}}>Flagship Feature</div>
            <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,textTransform:'uppercase',fontSize:'1.35rem',color:'#fff',lineHeight:1}}>12-Week AI <span style={{color:'#CCFF00'}}>Programme</span></div>
          </div>
        </div>
        <div style={{fontSize:'0.8rem',color:'rgba(255,255,255,0.45)',fontFamily:"'Barlow',sans-serif",lineHeight:1.55,marginBottom:'1rem'}}>Claude builds your complete personalised programme. 4 questions. Unique to you. Progressive overload built in.</div>
        <div style={{background:'rgba(204,255,0,0.1)',border:'1px solid rgba(204,255,0,0.2)',borderRadius:'12px',padding:'0.7rem 0.9rem',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
          <span style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'0.85rem',textTransform:'uppercase',letterSpacing:'0.08em',color:'#CCFF00'}}>Generate My Programme</span>
          <span style={{color:'#CCFF00',fontSize:'1.1rem',animation:'float 2s ease-in-out infinite'}}>→</span>
        </div>
      </div>
    );
  }
  ...
  const GS=GOAL_STYLE[config?.goal]||GOAL_STYLE.muscle;
  const totalWeeks=(progGet(PK.phase1)?.weeks?.length||0)+(progGet(PK.phase2)?.weeks?.length||0)+(progGet(PK.phase3)?.weeks?.length||0)||4;
  const totalSessions=totalWeeks*(config?.days||4);
  const progressPct=totalSessions>0?Math.round((completed.length/totalSessions)*100):0;

  // Get today's session label safely
  let todayLabel='Session';
  try{
    const allWeeks=[...(progGet(PK.phase1)?.weeks||[]),...(progGet(PK.phase2)?.weeks||[]),...(progGet(PK.phase3)?.weeks||[])];
    const wk=allWeeks.find(w=>w?.week===currentWeek);
    const sessions=wk?.sessions||buildFallbackSessions(config?.days||4,config?.level||'intermediate',currentWeek);
    todayLabel=sessions[currentDay]?.label||`Session ${currentDay+1}`;
  }catch(e){}

  const sessionDone=completed.includes(`w${currentWeek}d${currentDay}`);

  return(
    <div onClick={()=>onNavigate('sidebar','programme')} className="press" style={{background:`linear-gradient(145deg,${GS.bg},rgba(0,0,0,0.5))`,backdropFilter:'blur(20px)',border:`1px solid ${GS.border}`,borderRadius:'22px',padding:'1.25rem',marginBottom:'0.75rem',cursor:'pointer',position:'relative',overflow:'hidden',animation:'fadeUp 0.5s ease both',boxShadow:`0 8px 32px ${GS.glow}`}}>
      <div style={{position:'absolute',top:'-30px',right:'-30px',width:'100px',height:'100px',borderRadius:'50%',background:GS.bg,filter:'blur(25px)',pointerEvents:'none'}}/>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:'0.85rem',position:'relative',zIndex:1}}>
        <div>
          <div style={{fontSize:'0.58rem',fontWeight:800,letterSpacing:'0.18em',textTransform:'uppercase',color:GS.accent,fontFamily:"'Barlow Condensed',sans-serif",marginBottom:'3px'}}>12-Week Programme</div>
          <div style={{fontSize:'1.5rem',fontWeight:900,fontFamily:"'Barlow Condensed',sans-serif",textTransform:'uppercase',color:'#fff',lineHeight:1}}>{GS.icon} {phase1?.name||'Your Programme'}</div>
          <div style={{fontSize:'0.72rem',color:'rgba(255,255,255,0.35)',fontFamily:"'Barlow',sans-serif",marginTop:'3px'}}>Week {currentWeek} · {sessionDone?'Up next':'Today'}: {todayLabel}</div>
        </div>
        <div style={{background:`${GS.accent}18`,border:`1px solid ${GS.accent}35`,borderRadius:'12px',padding:'0.5rem 0.75rem',textAlign:'center',flexShrink:0}}>
          <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:'1.5rem',color:GS.accent,lineHeight:1}}>{progressPct}%</div>
      ...
      <div style={{height:'4px',background:'rgba(255,255,255,0.07)',borderRadius:'2px',overflow:'hidden',marginBottom:'0.85rem',position:'relative',zIndex:1}}>
        <div style={{height:'100%',width:`${progressPct}%`,background:`linear-gradient(90deg,${GS.accent},${GS.accent}bb)`,borderRadius:'2px',transition:'width 0.8s ease',boxShadow:`0 0 8px ${GS.glow}`}}/>
      </div>
      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',background:'rgba(0,0,0,0.2)',borderRadius:'12px',padding:'0.7rem 0.9rem',position:'relative',zIndex:1}}>
        <div>
          <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,textTransform:'uppercase',fontSize:'0.85rem',color:'#fff'}}>{todayLabel}</div>
          <div style={{fontSize:'0.65rem',color:'rgba(255,255,255,0.3)',fontFamily:"'Barlow',sans-serif",marginTop:'1px'}}>Tap to open your programme</div>
        </div>
...
function FirstTimeFlow({onDone}){
  ...
  const STEPS=[
    {
      type:"welcome",
      headline:`Welcome,\n${name}.`,
      sub:"You just made the best investment you'll make this year.",
      detail:"Your body transforms in the next 12 weeks. We built this around you — your goal, your schedule, your level.",
      cta:"Let's Build You →",
    ...
    },
    {
      ...
      icon:"🧬",
      headline:"Your AI\nProgramme",
      sub:"Not a template. Built for you.",
      detail:"Answer 4 questions and your 12-week programme generates in seconds. Exercises, sets, reps, rest — all calibrated to your body and goal. Adapts every 4 weeks.",
      cta:"Got It →",
    ...
    },
    {
      ...
      sub:"Log sets. Track weight. Chase PBs.",
      detail:"Every rep you log builds your history. The app spots when you're ready to go heavier and tells you. Your PRs are celebrated.",
      cta:"Let's Go →",
    ...
    },
    {
      ...
      icon:"🤖",
      headline:"Your Coach\nNever Sleeps",
      sub:"Ask anything. 3am, post-workout, pre-competition.",
      detail:"Your AI coach knows your programme, your goal and your history. Ask about form, nutrition, recovery or motivation. It's built around you.",
      cta:"Start ForgeBody 🔥",
  ...
  function next(){
    if(animating)return;
    if(s.last){localStorage.setItem("fb_onboarded_flow","true");onDone();return;}
    setAnimating(true);
    setTimeout(()=>{setStep(i=>i+1);setAnimating(false);},300);
  }

  return(
    <div style={{position:"fixed",inset:0,background:"#080808",zIndex:600,display:"flex",flexDirection:"column",overflow:"hidden"}}>

      {/* Ambient bg glow */}
      <div style={{position:"absolute",inset:0,background:`radial-gradient(ellipse 80% 50% at 50% 0%, ${s.accent}22 0%, transparent 60%)`,transition:"background 0.6s ease",pointerEvents:"none"}}/>

      {/* Progress dots */}
      <div style={{position:"absolute",top:"3rem",left:0,right:0,display:"flex",justifyContent:"center",gap:"6px",zIndex:2}}>
        {STEPS.map((_,i)=>(
          <div key={i} style={{width:i===step?"24px":"6px",height:"6px",borderRadius:"3px",
            background:i<=step?s.accent:"rgba(255,255,255,0.15)",
            transition:"all 0.4s ease",boxShadow:i===step?`0 0 8px ${s.accent}88`:""}}/>
        ))}
      </div>

      {/* Content */}
      <div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"0 1.75rem 3rem",position:"relative",zIndex:2,
        opacity:animating?0:1,transform:animating?"translateY(20px)":"translateY(0)",transition:"all 0.3s ease"}}>

        {step===0?(
          // Welcome step — special treatment
          <div>
            <div style={{fontSize:"0.65rem",fontWeight:800,letterSpacing:"0.2em",textTransform:"uppercase",
              color:s.accent,fontFamily:"'Barlow Condensed',sans-serif",marginBottom:"1rem"}}>ForgeBody</div>
            <div style={{fontSize:"3.8rem",fontWeight:900,fontFamily:"'Barlow Condensed',sans-serif",
              textTransform:"uppercase",letterSpacing:"-0.03em",color:"#fff",lineHeight:0.9,marginBottom:"1.25rem",
              whiteSpace:"pre-line"}}>{s.headline}</div>
            <div style={{fontSize:"1.1rem",fontWeight:700,color:"rgba(255,255,255,0.7)",
              fontFamily:"'Barlow',sans-serif",lineHeight:1.5,marginBottom:"0.75rem"}}>{s.sub}</div>
            <div style={{fontSize:"0.9rem",color:"rgba(255,255,255,0.4)",fontFamily:"'Barlow',sans-serif",
              lineHeight:1.65,marginBottom:"2.5rem"}}>{s.detail}</div>
          </div>
        ):(
          // Feature steps
          <div>
            <div style={{fontSize:"4rem",marginBottom:"1.5rem"}}>{s.icon}</div>
            <div style={{fontSize:"3.2rem",fontWeight:900,fontFamily:"'Barlow Condensed',sans-serif",
              textTransform:"uppercase",letterSpacing:"-0.03em",color:"#fff",lineHeight:0.9,
              marginBottom:"0.85rem",whiteSpace:"pre-line"}}>{s.headline}</div>
            <div style={{fontSize:"1rem",fontWeight:700,color:s.accent,
              fontFamily:"'Barlow',sans-serif",marginBottom:"0.75rem"}}>{s.sub}</div>
            <div style={{fontSize:"0.88rem",color:"rgba(255,255,255,0.4)",fontFamily:"'Barlow',sans-serif",
              lineHeight:1.65,marginBottom:"2.5rem"}}>{s.detail}</div>
          </div>
        )}

        <button onClick={next} style={{width:"100%",padding:"1.1rem",
          background:s.last?"#CCFF00":s.accent,
          color:s.last||s.accent==="#CCFF00"?"#000":"#fff",
          border:"none",borderRadius:"16px",fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,
          fontSize:"1.05rem",letterSpacing:"0.08em",textTransform:"uppercase",cursor:"pointer",
          boxShadow:`0 8px 32px ${s.accent}44`}}>
          {s.cta}
        </button>

        {!s.last&&(
          <button onClick={()=>{localStorage.setItem("fb_onboarded_flow","true");onDone();}}
            style={{width:"100%",padding:"0.85rem",background:"transparent",border:"none",
              color:"rgba(255,255,255,0.25)",fontFamily:"'Barlow',sans-serif",fontSize:"0.85rem",
...
class AppErrorBoundary extends React.Component{
  ...
  render(){
    if(this.state.hasError){
      return(
        <div style={{background:"#0a0a0a",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"2rem",textAlign:"center",fontFamily:"'Barlow Condensed',sans-serif"}}>
          <div style={{fontSize:"3rem",marginBottom:"1rem"}}>⚠️</div>
          <div style={{fontWeight:900,textTransform:"uppercase",fontSize:"1.3rem",color:"#fff",marginBottom:"0.5rem"}}>App Error</div>
          <div style={{fontSize:"0.82rem",color:"rgba(255,255,255,0.5)",fontFamily:"'Barlow',sans-serif",marginBottom:"1.5rem",maxWidth:"320px"}}>{this.state.error?.message||"Something went wrong"}</div>
          <button onClick={()=>window.location.reload()} style={{padding:"0.75rem 2rem",background:"#CCFF00",color:"#000",border:"none",borderRadius:"10px",fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:"0.9rem",textTransform:"uppercase",cursor:"pointer"}}>Reload App</button>
        </div>
      );
    }
    return this.props.children;
